...
class Planetoids(GameApp):
    ...
    def start(self):
        ...
        self._title = GLabel(text="Planetoids", font_size=72, x=center_x, y=center_y,
                                linecolor='#349441', font_name='Arcade')
        self._title.font = '-bold-72'
        
            # Create and draw the message
        self._message = GLabel(text="Press 'S' to Start", font_size=36, x=center_x,
                                    y=center_y + 100, linecolor='black', font_name='Arcade')
    ...
    def _determinestate(self):
        ...
        change = self.input.is_key_down('s') and self.lastkeys == 0
